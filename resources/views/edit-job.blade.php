<x-layout>
    <x-container>
        ...
        <x-forms.form action="/job/create" method="post" enctype="multipart/form-data" class="space-y-5">
            @csrf
            @php
            ...
            <x-forms.fields label="Rating" name="rating" class="{{ $style }}" placeholder="Eg. 4.3 (out of 5)">{{ $job->salary }}</x-forms.fields>
